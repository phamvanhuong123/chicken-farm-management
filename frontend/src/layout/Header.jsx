...
function Header({ onToggleSidebar, isSidebarCollapsed }) {
  ...
  return (
    ...
    <div className="flex flex-row px-6 bg-white border border-gray-200 h-14 fixed top-0 left-0 right-0 z-50">
      <div className={`${isSidebarCollapsed ? 'w-20' : 'w-[232px]'} transition-all duration-300 ease-in-out  flex justify-between border-r border-gray-200 items-center`}>
        <p className="font-bold">Farm Go</p>
      </div>
      <div className="px-2 flex flex-1 items-center justify-between">
        <div className="flex  items-center gap-1.5 ">
          <button className="cursor-pointer">
            {isSidebarCollapsed ? <RiMenuFold2Line onClick={onToggleSidebar} /> :  <RiMenuFold2Fill onClick={onToggleSidebar} />}
          </button>
        ...
        <div className="relative">
          ...
          >
            ...
            <span className="text-sm font-medium text-black">Tài khoản</span>
            <ChevronDown
              size={16}
              color='#000'
              ...
              <div className="absolute right-0 top-full mt-2 w-48 bg-white rounded-xl shadow-lg border border-gray-200  py-2 z-50">
                ...
                <div className="py-2">
                  ...
                  >
                    ...
                    <span className="text-sm font-medium text-black">Đăng nhập</span>
                  </NavLink>
                  ...
                  >
                    ...
                    <span className="text-sm font-medium text-black">Đăng ký</span>
                  </NavLink>
                </div>
